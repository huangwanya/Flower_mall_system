...
<div>
    ...
    <el-form :inline="true" :model="formSearch" class="list-form-pv" :style='{"padding":"30px 20px 30px","margin":"20px 7% 0","borderColor":"#00adb5","alignItems":"center","borderRadius":"0px","flexWrap":"wrap","background":"none","borderWidth":"0px 0 0px 0","display":"flex","width":"100%","borderStyle":"dashed","height":"auto"}'>
      <el-form-item :style='{"alignItems":"center","margin":"0 4px 0 0","display":"flex"}'>
	    <div class="lable" v-if="true" :style='{"width":"auto","padding":"0 10px","lineHeight":"42px","display":"inline-block"}'>鲜花名称</div>
        <el-input v-model="formSearch.xianhuamingcheng" placeholder="鲜花名称" clearable></el-input>
      </el-form-item>
      <el-form-item :style='{"alignItems":"center","margin":"0 4px 0 0","display":"flex"}'>
	    <div class="lable" v-if="true" :style='{"width":"auto","padding":"0 10px","lineHeight":"42px","display":"inline-block"}'>鲜花花语</div>
        <el-input v-model="formSearch.xianhuahuayu" placeholder="鲜花花语" clearable></el-input>
      </el-form-item>
      <el-form-item :style='{"alignItems":"center","margin":"0 4px 0 0","display":"flex"}'>
	    <div class="lable" v-if="true" :style='{"width":"auto","padding":"0 10px","lineHeight":"42px","display":"inline-block"}'>适用场景</div>
        <el-input v-model="formSearch.shiyongchangjing" placeholder="适用场景" clearable></el-input>
      </el-form-item>
      <el-form-item :style='{"alignItems":"center","margin":"0 4px 0 0","display":"flex"}'>
	    <div class="lable" v-if="true" :style='{"width":"auto","padding":"0 10px","lineHeight":"42px","display":"inline-block"}'>送礼对象</div>
        <el-input v-model="formSearch.songliduixiang" placeholder="送礼对象" clearable></el-input>
      </el-form-item>
      <el-form-item :style='{"alignItems":"center","margin":"0 4px 0 0","display":"flex"}'>
	...
	<div class="list" :style='{"padding":"0px 0 20px","margin":"20px 7% 0px","background":"none","flex":"1","width":"100%","minWidth":"750px","order":"2"}'>
		...
		<div class="list2 index-pv1" :style='{"padding":"0 0px","margin":"20px 0 0","borderRadius":"0px","flexWrap":"wrap","background":"none","display":"flex","width":"100%","justifyContent":"space-between","height":"auto"}'>
			<div :style='{"border":"0px solid #eee","cursor":"pointer","padding":"10px","boxShadow":"0px 0px 0px #eee","margin":"0 0 20px","display":"flex","justifyContent":"space-between","borderRadius":"0px","flexWrap":"wrap","background":"none","width":"25%","fontSize":"0","position":"relative","height":"auto"}' v-for="(item, index) in dataList" :key="index" @click="toDetail(item)" class="list-item animation-box">
				<img :style='{"cursor":"pointer","padding":"10px","boxShadow":"0px 6px 6px -6px #80afba","borderColor":"#0087a7 #bdeaf4 #0087a7 #bdeaf4","margin":"0px 0 0","objectFit":"cover","display":"inline-block","borderRadius":"20px","borderWidth":"1px 2px 2px 1px","background":"none","width":"100%","borderStyle":"dotted","height":"320px"}' v-if="item.xianhuatupian && item.xianhuatupian.substr(0,4)=='http'" :src="item.xianhuatupian" class="image" />
				<img :style='{"cursor":"pointer","padding":"10px","boxShadow":"0px 6px 6px -6px #80afba","borderColor":"#0087a7 #bdeaf4 #0087a7 #bdeaf4","margin":"0px 0 0","objectFit":"cover","display":"inline-block","borderRadius":"20px","borderWidth":"1px 2px 2px 1px","background":"none","width":"100%","borderStyle":"dotted","height":"320px"}' v-else :src="baseUrl + (item.xianhuatupian?item.xianhuatupian.split(',')[0]:'')" class="image" />
				<div class="item-info" :style='{"padding":"10px 0px 0","boxShadow":"0px 12px 12px -12px #80afba","alignSelf":"center","borderColor":"#bdeaf4 #0087a7 #bdeaf4 #0087a7","margin":"20px 0 0","display":"flex","justifyContent":"center","overflow":"hidden","borderRadius":"10px","flexWrap":"wrap","borderWidth":"1px 1px 3px 4px","background":"url(http://codegen.caihongy.cn/20230210/7d53b0e6bd6b44dc87a1dcd33f7af58f.gif)","width":"100%","borderStyle":"solid","height":"auo"}'>
					<div :style='{"padding":"0 6px","borderColor":"#9dcde9","margin":"0 10px 10px 0","color":"#333","alignItems":"center","textAlign":"center","display":"flex","justifyContent":"center","overflow":"hidden","background":"none","borderWidth":"0 0 0px","width":"100%","lineHeight":"16px","fontSize":"14px","borderStyle":"dotted"}' class="name ">鲜花名称:{{item.xianhuamingcheng}}</div>
					<div :style='{"padding":"0 6px","borderColor":"#9dcde9","margin":"0 10px 10px 0","color":"#333","alignItems":"center","textAlign":"center","display":"flex","justifyContent":"center","overflow":"hidden","background":"none","borderWidth":"0 0 0px","width":"100%","lineHeight":"16px","fontSize":"14px","borderStyle":"dotted"}' class="name ">{{item.xianhualeixing}}</div>
...
<script>
  export default {
    ...
    methods: {
      ...
      getFenlei() {
        this.$http.get('option/xianhualeixing/xianhualeixing').then(res => {
          if (res.data.code == 0) {
      ...
      getList(page, fenlei, ref = '') {
        ...
        if (this.formSearch.xianhuahuayu != '') searchWhere.xianhuahuayu = '%' + this.formSearch.xianhuahuayu + '%';
        ...
        if (this.curFenlei != '全部') searchWhere.xianhualeixing = this.curFenlei;
        this.$http.get('xianhuaxinxi/list', {params: Object.assign(params, searchWhere)}).then(res => {
          if (res.data.code == 0) {
      ...
      toDetail(item) {
        this.$router.push({path: '/index/xianhuaxinxiDetail', query: {detailObj: JSON.stringify(item)}});
      },
    }
  }
</script>
