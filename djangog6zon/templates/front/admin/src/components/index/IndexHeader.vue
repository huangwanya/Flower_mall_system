<template>
	<div class="navbar">
		<div class="title" :style='{"width":"1200px","padding":"0 20px","margin":"0 auto","textAlign":"center","background":"none","display":"block"}'>
			...
			<span class="title-name" :style='{"padding":"0","lineHeight":"64px","fontSize":"18px","color":"#fff"}'>{{this.$project.projectName}}</span>
		</div>
		<div class="right" :style='{"top":"10px","textAlign":"right","background":"none","display":"flex","position":"absolute","right":"60px","float":"right"}'>
