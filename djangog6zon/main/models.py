...
class kehu(BaseModel):
    ...
    __loginUserColumn__='kehuzhanghao'#用户表，表属性loginUserColumn对应的值就是用户名字段，mima就是密码字段
    ...
    kehuzhanghao=models.CharField ( max_length=255,null=False,unique=True, verbose_name='客户账号' )
    mima=models.CharField ( max_length=255,null=False, unique=False, verbose_name='密码' )
    kehuxingming=models.CharField ( max_length=255, null=True, unique=False, verbose_name='客户姓名' )
    ...
    '''
    kehuzhanghao=VARCHAR
    mima=VARCHAR
    kehuxingming=VARCHAR
    touxiang=Text
    nianling=VARCHAR
    xingbie=VARCHAR
...
class xianhualeixing(BaseModel):
    __doc__ = u'''xianhualeixing'''
    __tablename__ = 'xianhualeixing'
    ...
    __isAdmin__='否'#表属性isAdmin=”是”,刷出来的用户表也是管理员，即page和list可以查看所有人的考试记录(同时应用于其他表)
    addtime = models.DateTimeField(auto_now_add=False, verbose_name=u'创建时间')
    xianhualeixing=models.CharField ( max_length=255, null=True, unique=False, verbose_name='鲜花类型' )
    '''
    xianhualeixing=VARCHAR
    '''
    class Meta:
        db_table = 'xianhualeixing'
        verbose_name = verbose_name_plural = '鲜花类型'
class xianhuaxinxi(BaseModel):
    __doc__ = u'''xianhuaxinxi'''
    __tablename__ = 'xianhuaxinxi'
    ...
    __isAdmin__='否'#表属性isAdmin=”是”,刷出来的用户表也是管理员，即page和list可以查看所有人的考试记录(同时应用于其他表)
    addtime = models.DateTimeField(auto_now_add=False, verbose_name=u'创建时间')
    xianhuamingcheng=models.CharField ( max_length=255,null=False, unique=False, verbose_name='鲜花名称' )
    xianhualeixing=models.CharField ( max_length=255,null=False, unique=False, verbose_name='鲜花类型' )
    xianhuatupian=models.TextField   (  null=True, unique=False, verbose_name='鲜花图片' )
    xianhuaguige=models.CharField ( max_length=255, null=True, unique=False, verbose_name='鲜花规格' )
    xianhuachandi=models.CharField ( max_length=255, null=True, unique=False, verbose_name='鲜花产地' )
    xianhuahuayu=models.CharField ( max_length=255, null=True, unique=False, verbose_name='鲜花花语' )
    shiyongchangjing=models.CharField ( max_length=255, null=True, unique=False, verbose_name='适用场景' )
    songliduixiang=models.CharField ( max_length=255, null=True, unique=False, verbose_name='送礼对象' )
    xianhuaxiangqing=models.TextField   (  null=True, unique=False, verbose_name='鲜花详情' )
    ...
    vipprice=models.FloatField   (  null=True, unique=False,default='-1', verbose_name='会员价' )
    '''
    xianhuamingcheng=VARCHAR
    xianhualeixing=VARCHAR
    xianhuatupian=Text
    xianhuaguige=VARCHAR
    xianhuachandi=VARCHAR
    xianhuahuayu=VARCHAR
    shiyongchangjing=VARCHAR
    songliduixiang=VARCHAR
    xianhuaxiangqing=Text
    ...
    '''
    class Meta:
        db_table = 'xianhuaxinxi'
        verbose_name = verbose_name_plural = '鲜花信息'
class cart(BaseModel):
    ...
    addtime = models.DateTimeField(auto_now_add=False, verbose_name=u'创建时间')
    tablename=models.CharField ( max_length=255, null=True, unique=False,default='xianhuaxinxi', verbose_name='商品表名' )
...
class news(BaseModel):
    ...
    class Meta:
        db_table = 'news'
        verbose_name = verbose_name_plural = '鲜花资讯'
...
class systemintro(BaseModel):
    ...
    class Meta:
        ...
        verbose_name = verbose_name_plural = '关于我们'
class discussxianhuaxinxi(BaseModel):
    __doc__ = u'''discussxianhuaxinxi'''
    __tablename__ = 'discussxianhuaxinxi'
    ...
    '''
    class Meta:
        db_table = 'discussxianhuaxinxi'
        verbose_name = verbose_name_plural = '鲜花信息评论表'
